...
require (
	...
	github.com/gasmod/gas/auth v0.4.4
	github.com/gasmod/gas/cache v0.4.4
	github.com/gasmod/gas/config v0.4.4
	github.com/gasmod/gas/database v0.4.4
	github.com/gasmod/gas/email v0.4.4
	github.com/gasmod/gas/log v0.4.4
	github.com/gasmod/gas/migrate v0.4.4
	github.com/gasmod/gas/queue v0.4.4
	github.com/gasmod/gas/storage v0.4.4
	github.com/gasmod/gas/template v0.4.4
